...
if (isActionAccessible($guid, $connection2, "/modules/Query Builder/queries_delete.php")==FALSE) {
	...
	if ($queryBuilderQueryID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<? print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/queries_deleteProcess.php?queryBuilderQueryID=$queryBuilderQueryID" ?>">
