...
if (isActionAccessible($guid, $connection2, "/modules/Query Builder/queries_duplicate.php")==FALSE) {
	...
	if ($queryBuilderQueryID=="") {
		...
		if ($result->rowCount()!=1) {
			...
			$row=$result->fetch() ;
			?>
			<form method="post" action="<? print $_SESSION[$guid]["absoluteURL"] . "/modules/" . $_SESSION[$guid]["module"] . "/queries_duplicateProcess.php?queryBuilderQueryID=$queryBuilderQueryID" ?>">
				<table class='smallIntBorder' cellspacing='0' style="width: 100%">	
					<tr>
						<td> 
							<b><? print _('New Name') ?> *</b><br/>
						</td>
						<td class="right">
